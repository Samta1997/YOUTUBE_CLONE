...
const LeftSideBar1 = () => {
  return (
    <div className="px-l-4 w-20 flex-col bg-gradient-to-b from-indigo-500 via-purple-500 to-pink-500 w-24 text-white">
        <div className="mx-auto py-3 flex-col hover:bg-gradient-to-l hover:from-pink-500 hover:to-yellow-500">
            <NavLink to={'/'}>
                <MdHome className="mx-4 text-2xl"/>
                <div className="text-xs mx-3">Home</div>
            </NavLink>
        </div>
        <div className="mx-auto py-3 flex-col justify-center ">
